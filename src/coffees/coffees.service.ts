...
export class CoffeesService {
    ...
    findAll(paginationQueryDto: PaginationQueryDto) {
        //we have to explicitly specify what relations we want to be resolved
        return this.coffeeRepository.find({
            relations: ["flavors"],  //Indicates what relations of entity should be populated (simplified left join form).
